import svgPaths from "./svg-d6b0c8fbcm";
import img22 from "figma:asset/c525837af345f4c9a7636d629dea2a6699465f2c.png";
  ...
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="description">
      <div className="flex flex-col font-['NPS_font:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#fdfbfd] text-[24px] tracking-[-0.48px] whitespace-nowrap">
        <p className="leading-none">어떤 어휘인지 보고, 직접 입력해보세요!</p>
      </div>
    </div>
  );
}
...
function Texts() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center leading-[0] relative shrink-0 text-white w-[518px] whitespace-nowrap" data-name="texts">
      <div className="flex flex-col font-['Noto_Sans_KR:Bold',sans-serif] font-bold justify-center opacity-30 relative shrink-0 text-[40px] tracking-[-0.8px]">
        <p className="leading-[1.2]">정답을 입력해주세요</p>
      </div>
...
export default function Component() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center py-[32px] relative size-full" data-name="2단계-2_몰라요 선택 (또는 알아요_정답 기회 소진)">
