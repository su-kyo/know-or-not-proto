import svgPaths from "./svg-8kjy5zrvnw";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="multiple">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="multiple">
          <path d={svgPaths.p16fe2600} fill="var(--fill-0, #804529)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[8px] shrink-0 w-full" data-name="container">
      <div className="bg-[#f2e1d9] content-stretch flex h-[32px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0 w-[110px]" data-name="li">
        <div className="flex flex-[1_0_0] flex-col font-['Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] min-h-px min-w-px relative text-[#804529] text-[16px] text-center tracking-[-0.32px]">
          <p className="leading-[1.5] whitespace-pre-wrap">영상 1</p>
        </div>
      </div>
      <button className="bg-[#f8c2a8] content-stretch cursor-pointer flex h-[32px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0 w-[110px]" data-name="li">
        <div className="flex flex-[1_0_0] flex-col font-['Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] min-h-px min-w-px relative text-[#804529] text-[16px] text-center tracking-[-0.32px]">
          <p className="leading-[1.5] whitespace-pre-wrap">영상 2</p>
        </div>
      </button>
    </div>
  );
...
function AdditionalList() {
  return (
    <div className="absolute bg-[#f2e1d9] content-stretch flex flex-col items-start left-[621px] p-[2px] rounded-[10px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] top-[66.3px]" data-name="additional-list">
      <Container1 />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center py-[32px] relative size-full" data-name="1단계_초기 화면-추가자료">
