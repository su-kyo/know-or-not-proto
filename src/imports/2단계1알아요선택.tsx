import svgPaths from "./svg-v8q8v7mu8t";
import img21 from "figma:asset/c525837af345f4c9a7636d629dea2a6699465f2c.png";
...
export default function Component() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center py-[32px] relative size-full" data-name="2단계-1_알아요 선택">
